...
FUI.env.getCurrentUser = function () {
	$.ajax({
                type: 'get',
                url: "/fwp/GetCurrentUser.fwp",
                dataType: "json",
				async: false,
...
FUI.env.app = null;
FUI.env.home = null;
FUI.env.isPhoneMode = false;
FUI.env.ssoUrl = "";

if (window != top) {
    FUI.env.us = top.FUI.env.us;
    FUI.env.log = top.FUI.env.log;
    FUI.env.cfg = top.FUI.env.cfg;
    FUI.env.portal = top.FUI.env.portal;
    FUI.env.app = top.FUI.env.app;
    FUI.env.home = top.FUI.env.home;
}
/*****************************************************************************************
*
*			扩展方法工具包
